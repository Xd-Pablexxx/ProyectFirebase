...
class AdapterPedidoDetalle: RecyclerView.Adapter<AdapterPedidoDetalle.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterPedidoDetalle.ViewHolder {
        var view=
            LayoutInflater.from(parent.context).inflate(R.layout.row_pedidodetalle,parent,false)
        var viewHolder=ViewHolder(view)
        return viewHolder
    }

    override fun onBindViewHolder(holder: AdapterPedidoDetalle.ViewHolder, position: Int) {
